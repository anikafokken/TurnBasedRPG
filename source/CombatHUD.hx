...
class CombatHUD extends FlxTypedGroup<FlxSprite>
{
	...
	public function new()
	{
		...
		// create out damage texts. We'll make them be white text with a red shadow (so they stand out).
	...
	**/
	...
	/**
		When we've finished fading in, we set out hud to active (so it gets update), and allow the playerSprite to interact. We show our pointer, too.
	**/
    ...
    **/
    ...
    /**
        This function is called from out Tweens to move the damage displays up on the screen
    **/
